...
class DN_Image {
  ...
  public $errors;
	public $image_library		= 'gd2';  	// imagemagick, netpbm, gd, gd2
	public $library_path		= '';
  ...
  private $dir_write_mode = 0777;

	public function DN_Image($args = array())
	{
		if (count($args) > 0)
		{
	...
	{
		$args = array('source_folder', 'dest_folder', 'source_image', 'full_src_path', 'full_dst_path', 'new_image', 'image_type', 'size_str', 'quality', 'orig_width', 'orig_height', 'rotation_angle', 'x_axis', 'y_axis', 'create_fnc', 'copy_fnc', 'wm_overlay_path', 'wm_use_truetype', 'dynamic_output', 'wm_font_size', 'wm_text', 'wm_vrt_alignment', 'wm_hor_alignment', 'wm_padding', 'wm_hor_offset', 'wm_vrt_offset', 'wm_font_color', 'wm_use_drop_shadow', 'wm_shadow_color', 'wm_shadow_distance', 'wm_opacity');
	...
	public function initialize($args = array())
	{
		...
		{
			$this->errors = 'imglib_source_image_required';
			return FALSE;	   
		}
    
		if ( ! function_exists('getimagesize'))
		{
			$this->errors = 'imglib_gd_required_for_args';
			return FALSE;
		}
	...
	function rotate()
	{
		...
		{
			$this->errors = 'imglib_rotation_angle_required';
			return FALSE;	   
		}
	...
	function image_process_imagemagick($action = 'resize')
	{
		...
		{
			$this->errors = 'imglib_libpath_invalid';
			return FALSE;
		}
		...
		if ($retval > 0)
		{
			$this->errors = 'imglib_image_process_failed';
			return FALSE;
		}
	...
	function image_rotate_gd()
	{
		...
		{
			$this->errors = 'imglib_rotate_unsupported';
			return FALSE;
		}
	...
	function overlay_watermark()
	{
		...
		{
			$this->errors = 'imglib_gd_required';
			return FALSE;
		}
		...
		$args 			= $this->get_image_properties($this->wm_overlay_path, TRUE);
		$wm_img_type	= $args['image_type'];
		$wm_width		= $args['width'];
		$wm_height		= $args['height'];
	...
	function text_watermark()
	{
		...
		{
			$this->errors = 'imglib_missing_font';
			return FALSE;
		}
	...
	function image_create_gd($path = '', $image_type = '')
	{
		...
		switch ($image_type)
		{
			case	 1 :
						...
						{
							$this->errors = 'imglib_unsupported_imagecreate, imglib_gif_not_supported';
							return FALSE;
						}
			...
			case 2 :
						...
						{
							$this->errors = 'imglib_unsupported_imagecreate, imglib_jpg_not_supported';
							return FALSE;
						}
			...
			case 3 :
						...
						{
							$this->errors = 'imglib_unsupported_imagecreate, imglib_png_not_supported';
							return FALSE;
						}
		...
		$this->errors = 'imglib_unsupported_imagecreate';
		return FALSE;
	}
      ...
      mkdir($this->dest_folder , 0777, TRUE);
		...
		switch ($this->image_type)
		{
			case 1 :
						...
						{
							$this->errors = 'imglib_save_failed';
							return FALSE;
						}
				break;
			case 2	:
	...
	function get_image_properties($path = '', $return = FALSE)
	{
		...
		if ( ! file_exists($path))
		{
			$this->errors = 'imglib_invalid_path';
			return FALSE;
		}
