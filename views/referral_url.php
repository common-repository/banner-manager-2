...
<div class="wrap">
  ...
  <h2>
    ...
    <a class="button add-new-h2" href="<?php echo get_admin_url().'admin.php?page=dn_bm-referral_url&act=edit'; ?>">Add New</a>
  </h2>
  ...
  <div class="bm_wrap">
    <form name="insert_event_form" id="insert_event_form" method="POST" action="" enctype="multipart/form-data">
      <table class="widefat">
        ...
        <?php if(count($referral_url_list) > 0): foreach($referral_url_list as $pul): ?>
        <tbody>
          <tr class="<?php $i++; echo (($i%2) == 1)?'':'alternate'; ?>">
            <td scope="col"><?php echo $pul->id; ?></td>
            <td scope="col"><img src="<?php echo BM_CONTENT_UPLOADS_URL._REF._TMP.'/mini_'.$pul->img_src; ?>?ver=<?php echo date('mydhis'); ?>" /></td>
            ...
            <td scope="col">
              <a class="dn_icon-1" href="<?php echo WP_ADMIN_URL.'admin.php?page=dn_bm-referral_url&act=edit&bm_id='.$pul->id; ?>" title="edit">&nbsp;</a>
              <a class="dn_icon-2" href="<?php echo wp_nonce_url(WP_ADMIN_URL.'admin.php?page=dn_bm-referral_url&act=del&bm_id='.$pul->id, 'dn-bm-delete-referral_url'); ?>" title="delete">&nbsp;</a>
              <a class="<?php echo ($pul->active == 1)?'dn_icon-3':'dn_icon-5'; ?>" href="<?php echo wp_nonce_url(WP_ADMIN_URL.'admin.php?page=dn_bm-referral_url&act=act&action='.$pul->active.'&bm_id='.$pul->id, 'dn-bm-active-referral_url'); ?>" title="active/inactive">&nbsp;</a> 
            </td>
          </tr>
        </tbody>
