...
<div class="wrap">
  ...
  <h2>Banner Manager - Page Events</h2>
      ...
      <table class="widefat bm">
        ...
        <tbody>
              ...
              <td>
                ...
                <div class="existing_image_outer_container">
                    ...
                    <div class="existing_image_inner_container_img">
                      <img src="<?php echo BM_CONTENT_UPLOADS_URL._REF._ORI.'/'.$existing_image->img_src; ?>" />
                    </div>
                    
                    <div class="existing_image_inner_container_button">
                      <div id="show_image_button" class="ajax_button fleft">
                        <a class="thickbox" href="<?php echo $cropper_url.'?id='.$existing_image->id.'&type=3'.$thickbox_param; ?>">
                          Show Image
                        </a>
                      </div>
                ...
                <input type="hidden" name="referral_url[crop_cords]" id="bm_def_crop_cords" value="<?php echo $existing_image->crop_cords; ?>" />
          ...
          <tr valign="top">
            ...
            <td>:</td>
            <td>
              <input type="text" name="referral_url[ref_data]" class="wide" id="ref_data" value="<?php echo $existing_image->ref_data; ?>" />
            </td>
          </tr>
          <tr valign="top">
            <td>Image</td>
          ...
          <tr valign="top">
            ...
            <td>:</td>
            <td>
              <textarea name="referral_url[description]"><?php echo $existing_image->description; ?></textarea>
            </td>
          </tr>
          <tr valign="top">
            ...
            <td>:</td>
            <td>
              <input type="text" name="referral_url[link]" class="wide" id="link" value="<?php echo $existing_image->link; ?>" />
            </td>
          </tr>
          <tr valign="top">
            <td>Active</td>
            <td>:</td>
            <td>
              <input type="checkbox" id="bm_active" name="referral_url[active]" <?php echo ($existing_image->active)?'checked':''; ?> value="1" /> 
            </td>
          </tr>
          <tr valign="top">
            <td>&nbsp;</td>
            <td>
              <input type="hidden" name="referral_url[id]" id="bm_id" value="<?php echo $existing_image->id; ?>" />
              <input type="hidden" name="referral_url[file]" id="bm_file" value="<?php echo $existing_image->img_src; ?>" />
              <input type="hidden" name="referral_url[image_status]" id="bm_image_status" value="1" />
            </td>
            <td>
              <input class="button-primary" type="submit" name="save" value="Save" />
              <a href="<?php echo get_admin_url().'admin.php?page=dn_bm-referral_url'; ?>" class="button-primary delete"><span>Back</span></a>
              <?php wp_nonce_field('dn-bm-update-referral_url'); ?>
            </td>
          </tr>
        </tbody>
      </table>
